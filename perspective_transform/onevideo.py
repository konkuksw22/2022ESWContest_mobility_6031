...
def getsize(capture1):
    ...
    while True:
        perspective_transform(img_D, left, "tl")
        perspective_transform(img_D, right, "tr")
...
while cap_driver.isOpened() and flag == 1 :
    ...
    perspective_transform(frame, left,"tl")
    perspective_transform(frame, right,"tr")
